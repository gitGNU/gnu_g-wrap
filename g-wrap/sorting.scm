;;;; CHL (5/7/98) -- I am using this code from slib so that people do
;;;;  not need slib to run G-Wrap -- added a guile module interface for
;;;;  loading
;;;
